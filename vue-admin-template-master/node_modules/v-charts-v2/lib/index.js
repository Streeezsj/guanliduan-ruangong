(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('echarts/lib/echarts'), require('echarts/lib/component/tooltip'), require('echarts/lib/component/legend'), require('numeral'), require('echarts/lib/chart/line')) :
  typeof define === 'function' && define.amd ? define(['echarts/lib/echarts', 'echarts/lib/component/tooltip', 'echarts/lib/component/legend', 'numeral', 'echarts/lib/chart/line'], factory) :
  (global.VeIndex = factory(global.echarts,null,null,global.numeral));
}(this, (function (echarts,tooltip,legend,numeral) { 'use strict';
  ...
  var line$1 = function line$$1(options, columns, rows, settings, extra) {
  ...
  function setLegend(options) {
    ...
    if (!legendAlias && !labelAlias) legend$$1 = { data: displayMetrics };
